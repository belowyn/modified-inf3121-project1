...
public class Game {
    ...
    static private void print_victory(generirane labyrinth) {
	System.out.println();
	labyrinth.printMaze();
    ...
    static private void register_highscore(generirane labyrinth) {
    ...
    static private void setup_new_game(generirane labyrinth) {
	...
	while(true){
	    ...
	    print_victory(labyrinth);
	    register_highscore(labyrinth);
	    setup_new_game(labyrinth);
	}		
    }
}
